...
commands = [
    ...
    "d3x llms deploy -n demollama3 --model meta-llama/Meta-Llama-3-8B-Instruct  --type=a10 --token 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 --publish -sky",
    "d3x serve list",
    "d3x dataset ingest -d Foodprocessing --config /home/food_processing/demo_ingest.yaml",
    "cat /home/food_processing/ingest.yaml",
    "cat /home/food_processing/rag.yaml",
    "d3x dataset list",
    "d3x apps create --config /home/food_processing/securechat.yaml",
    "d3x /home/food_processing/eval.yaml"
