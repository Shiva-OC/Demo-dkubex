...
commands = [
    "python3 --version",
    "d3x dataset ingest -d demodata --config /home/data/demo_ingest.yaml",
    "d3x llms deploy -n demollama --model meta-llama/Llama-2-7b-chat-hf  --type=a10 --token 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 --publish -sky",
    "d3x dataset query ",
    "d3x serve down -a -y"
]
